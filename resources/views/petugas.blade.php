  ...
  <div class="col-md-16">
    ...
    <div class="p-3  bg-info text-white">
        <div class="header" align="center" >
            ...
            <a href="#" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal"><i class="fa fa-user-plus" aria-hidden="true"></i><b> Tambah Petugas</b></a>
			@endif
    </div>    
						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						      <div class="modal-header">
						        ...
						        <h4 class="modal-title" id="myModalLabel" align="center">Tambahkan Petugas</h4>
						      </div>
							...
							<section class="main-section">
								<div class="content">
									...
									<form action="{{ url('/tambah_petugas/store') }}" method="post">
									{{ csrf_field()}}
										<div align="left">
										<div class="form-group" >
											<label for="nama_petugas">Nama :</label>
											<input type="text" placeholder="Nama" class="form-control" id="nama_petugas" name="nama_petugas" required
										...
										<input type="hidden"  id="level" name="level" value="petugas" >
